...
const CASCADE_HELP = [
  ...
  { h: "Аналитический режим — гидрограф + выход вышестоящих КНС" },
  { p: "Ось времени разбивается на сегменты, внутри которых выход вышестоящих станций постоянен (c = const). На каждом сегменте суммарный приток — тот же дождевой гидрограф, сдвинутый по вертикали: Q(T) = Qдождь(T) + c, поэтому применимы формулы Приложения 8 с эффективным порогом Qнс − c:" },
  ...
  { h: "Аналитический режим — несколько дождевых гидрографов" },
  { p: "Сумма гидрографов ВОДГЕО с разными t_r или задержками сама не является гидрографом ВОДГЕО (она может иметь несколько пиков), поэтому свести её к одной кривой (Q_r*, t_r*) без потери точности нельзя. Исключение — гидрографы с одинаковыми t_r и n без задержек: их сумма точно равна гидрографу с Q_r = ΣQ_{r,i}." },
  ...
  { h: "Приближение эквивалентным гидрографом" },
  ...
  { h: "Численный режим" },
  { p: "Работа резервуара моделируется по шагам Δt = 0,20 мин: на каждом шаге уровень заполнения меняется на приток минус откачку, но не может стать отрицательным:" },
  ...
  { p: "«Рекомендации по расчёту систем сбора, отведения и очистки поверхностного стока селитебных территорий, площадок предприятий и определению условий выпуска его в водные объекты» (Методическое пособие, НИИ ВОДГЕО, 2015) — Приложение 8, формулы (1)–(3); п. 6.2.6 — коэффициенты покрова, таблицы 10–11." },
  { p: "СП 32.13330.2018 «Канализация. Наружные сети и сооружения» (актуализированная редакция СНиП 2.04.03-85) — Приложение Ж, формулы (Ж.1)–(Ж.2), таблицы Ж.6 и Ж.7." },
  { p: "«Пример расчёта количественных характеристик поверхностного стока…», ФГУП НИИ ВОДГЕО, Москва, 2006 — контрольный пример (Qr = 342,3 л/с; z_mid = 0,201)." },
];
