...
const CASCADE_HELP = [
  ...
  { h: "Численный режим" },
  { p: "Работа резервуара моделируется по шагам Δt = 0,2 мин: на каждом шаге уровень заполнения меняется на приток минус откачку, но не может стать отрицательным:" },
